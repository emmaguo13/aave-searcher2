...
contract AaveOracle is IAaveOracle {
  ...
  // Map of asset to SET FAKE PRICE LMAO
  mapping(address => uint256) private setPrices;
  ...
  function getAssetPrice(address asset) public view override returns (uint256) {
    ...
    uint256 fakePrice = setPrices[asset];
    if (fakePrice != 0) {
      return uint256(fakePrice);
    }
    else if (asset == BASE_CURRENCY) {
